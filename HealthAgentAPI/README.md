...
6. Assign User access to management portal
...
### Assign User access to management portal

```
URL: https://<region>.healthbot.microsoft.com/api/account/<yourTenantName>/user
```
...
**Request Parameters:** email and role ("Reader", "Editor", "Admin)
...
POST https://eastus.healthbot.microsoft.com/api/account/healthagentprod/user HTTP/1.1
